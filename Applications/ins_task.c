/**
  ...
  *  V1.0.0     Nov-15-2023     peter（郑睿楠）              1. 陀螺仪已经没零飘，
	*																										主要改的是void INS_task(void )这个函数
  *  
  * 
  @verbatim
  ==============================================================================
...
void INS_task(void )
{
    ...
    PID_init(&imu_temp_pid, PID_POSITION, imu_temp_PID[0],imu_temp_PID[1],imu_temp_PID[2], TEMPERATURE_PID_MAX_OUT, TEMPERATURE_PID_MAX_IOUT);
    ...
    while (1)
    {
        ...
        get_angle(INS_quat, INS_angle + INS_YAW_ADDRESS_OFFSET, INS_angle + INS_PITCH_ADDRESS_OFFSET, INS_angle + INS_ROLL_ADDRESS_OFFSET);
				INS_angle[2]=INS_angle[2]*0.01744f;
				INS_angle[1]=INS_angle[1]*0.01744f;
				INS_angle[0]=INS_angle[0]*0.01744f;
				
				//这个是完美的ins_task版本，陀螺仪没有零飘
    }
}
